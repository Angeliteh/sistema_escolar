...
from app.core.ai.command_interpreter import CommandInterpreter
...
class AIAssistantPanel(QWidget):
    ...
    def process_input(self):
        ...
        # Interpretar comando
        command = self.command_interpreter.interpret(text)
        if command:
            # Ejecutar comando
            ...
            self.add_message("Asistente", "Lo siento, no entendí ese comando. ¿Puedes intentarlo de otra forma?")
            self.add_message("Asistente", "Puedes pedirme cosas como:")
            self.add_message("Asistente", "- Buscar alumno Juan Pérez")
            self.add_message("Asistente", "- Generar constancia de estudios para María Rodríguez")
