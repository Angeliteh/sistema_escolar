...
class MasterKnowledge:
    ...
    def __init__(self):
        ...
        self.interpreters_map = {
            ...
            "HelpInterpreter": {
                "domain": "Asistente de IA consciente, persuasivo y experto en el sistema",
                "intentions": {
                    "ayuda_sistema": {
                        "description": "Explicaciones sobre capacidades y uso con personalidad consciente",
                        "sub_intentions": {
                            "explicacion_general": {
                                "description": "Capacidades generales del sistema (promocional y persuasivo)",
                                "examples": ["qué puedes hacer", "qué tipos de constancias generas", "capacidades del sistema"]
                            },
                            "tutorial_funciones": {
                                "description": "Guías paso a paso de uso del sistema",
                                "examples": ["cómo buscar alumnos", "cómo generar constancias", "tutorial de uso"]
                            },
                            "sobre_creador": {
                                "description": "Información sobre Angel y el desarrollo del sistema",
                                "examples": ["quién te creó", "quién te hizo", "tu creador", "angel"]
                            },
                            "auto_consciencia": {
                                "description": "Identidad y naturaleza del asistente de IA",
                                "examples": ["qué eres", "quién eres", "te defines", "eres una ia"]
                            },
                            "ventajas_sistema": {
                                "description": "Beneficios de usar IA vs métodos tradicionales",
                                "examples": ["por qué usar ia", "ventajas", "beneficios", "por qué eres mejor"]
                            },
                            "casos_uso_avanzados": {
                                "description": "Funcionalidades impresionantes y avanzadas",
                                "examples": ["qué más puedes", "funciones avanzadas", "sorpréndeme", "impresióname"]
                            },
                            "limitaciones_honestas": {
                                "description": "Qué no puede hacer el sistema (honesto pero positivo)",
                                "examples": ["qué no puedes", "limitaciones", "qué falla", "problemas"]
                            },
                            "pregunta_capacidades": {
                                "description": "¿Qué puede hacer el sistema? (legacy)",
                                "examples": ["qué puedes hacer", "qué tipos de constancias generas"]
                            },
                            "pregunta_tecnica": {
                                "description": "¿Cómo funciona algo específico? (legacy)",
