...
class HelpResponseGenerator:
    ...
    def generate_response_with_reflection(self, user_query: str, help_content: Dict) -> Optional[Dict]:
        ...
        try:
            ...
            # Crear prompt de respuesta + auto-reflexión
            response_prompt = self._build_response_prompt(user_query, help_content)
    ...
    def _build_response_prompt(self, user_query: str, help_content: Dict) -> str:
        """Construye el prompt para respuesta + auto-reflexión"""
        return f"""
