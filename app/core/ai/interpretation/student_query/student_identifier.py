...
class StudentIdentifier:
    ...
    def identify_student_from_context(self, user_query: str, conversation_stack: list) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            # ELIMINADO: _identify_by_fallback para evitar selecciones incorrectas
            strategies = [
    ...
    # MÉTODO ELIMINADO: _identify_by_fallback() causaba selecciones incorrectas
    # Si no se puede identificar específicamente, es mejor fallar que adivinar
