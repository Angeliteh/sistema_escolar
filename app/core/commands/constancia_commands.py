...
class GenerarConstanciaCommand(Command):
    ...
    def __init__(self, alumno_id: int, tipo_constancia: str, incluir_foto: bool = False, abrir_archivo: bool = False):
        """
        ...
        Args:
            ...
            abrir_archivo: Si se debe abrir el archivo generado (por defecto False)
        """
...
class TransformarConstanciaCommand(Command):
    ...
    def __init__(self, pdf_path: str, tipo_constancia: str, incluir_foto: bool = False,
                 guardar_alumno: bool = False, abrir_archivo: bool = False):
        """
        Inicializa el comando
